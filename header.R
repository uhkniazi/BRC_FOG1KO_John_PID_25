...
g_did = 46
gcswd = getwd()
gcRemoteDir = "/run/user/1000/gvfs/sftp:host=login.rosalind.kcl.ac.uk,user=k1625253/users/k1625253/scratch/old-scratch_rosalind-legacy-import_2020-01-28/Data/ProjectsData/BRC_FOG1KO_John_PID_25"
