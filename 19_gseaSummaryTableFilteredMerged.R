...
write.csv(dfMerged, file='results/mergedDownstream/gsea_msigdb_significant_c2_merged.xls')
...
aheatmap(mMat, annRow = T, scale = 'none', Rowv = order(g2:g1), Colv=NA, cexRow=5, cexCol = 0.6, #labCol=c('C2vC1', 'K1vC1', 'K2vC2', 'K2vK1'), 
