# File: 21_bam2ExpressedSequence.R
...
names(lConsensus) = paste(dfSample$group1, dfSample$group2, 
...
dir.create('results/alignments')
cvExport = paste0('results/alignments/', '13018_Ctcf.fasta')
