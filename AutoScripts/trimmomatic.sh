...
# 9. Run the program.
trimmomatic $inr1 $inr2 $outr1 $outr1up $outr2 $outr2up ILLUMINACLIP:/users/k1625253/scratch/old-scratch_rosalind-legacy-import_2020-01-28/Data/MetaData/trimmomatic_adapters.fa:2:30:10:8:true
